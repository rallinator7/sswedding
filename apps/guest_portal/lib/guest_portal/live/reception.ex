defmodule GuestPortal.Live.Reception do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col justify-center items-center w-full py-8">
      <h1 class="text-primary text-4xl">Sydney & Shay's</h1>
      <h1 class="text-primary text-4xl">Wedding Reception</h1>
